	...
	var cliente = $.ajax({
		...
		success:function(data){
			$.each(data, function(i, item){
				var nombre = document.getElementById("nombrescliente").value = item.nombreCliente;
			})
		}
	});
	}
  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <ul class="nav">
        ...
        <li class="nav-item">
          <a class="nav-link" href="reportes1.html">Reportes</a>
        </li>
      </ul>
                ...
                <div class="card-body">
                  ...
                  <div class="form-group d-flex">
                    <div class="col-md-6 d-flex" >
                      ...
                      <input type="submit" onclick="buscarCliente()" value="Consultar" class="btn btn-primary">
                    </div>
                    <div class="col-md-1"></div>   
                    <div class="col-md-5">

                      <input type="text" name="nombrescliente" id="nombrescliente" class="form-control col-md-6">
                    </div>
                  </div>
                  <div>
                    <br>
