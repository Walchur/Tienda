	...
	function editarUsuario() {
		...
		var editar = $.ajax({
			...
			url : "http://localhost:8080/editarUsuario?cedulaUsuario=" + cedula
					+ "&emailUsuario=" + correo + "&nombreUsuario=" + nombre
					+ "&password=" + pass + "&usuario=" + usuario,
			success : function(data) {
	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-md-12">
				...
				<form method="GET" onsubmit="editarUsuario()" role="form">
					<div class="container-fluid">
						<div class="row">
							<div class="col-md-12">
								<div class="row">
									<div class="col-md-2">
										...
										<div class="form-group">
											<label for="exampleInputEmail1">Contraseña:</label> <input
												type="text" name="pass" id="pass" class="form-control">
										</div>
										<div class="form-group">
