...
<script>
	...
	function editarProveedor(){
		...
		var editar = $.ajax({
			...
			success:function(data){
				window.location.href="http://localhost:8080/proveedor.jsp";
			}
		})
	}
</script>
...
<div class="container-fluid">
		<div class="row">
			<div class="col-md-12">
				...
				<form method="GET" onsubmit="editarProveedor()" role="form">
					<div class="container-fluid">
						<div class="row">
							<div class="col-md-12">
								<div class="row">
									<div class="col-md-2">
										<div class="form-group">
											<label for="exampleInputEmail1">NIT:</label> <input
												type="text" name="nit" id="nit" class="form-control" disabled>
										</div>
										<div class="form-group">
